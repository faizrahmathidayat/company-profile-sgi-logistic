...
<!-- Page Header -->
    <header class="page-header" style="background-image: url('{{ asset("assets/img/hero_logistics_1777043517461.webp") }}');">
                ...
                <div class="col-12">
                    <div class="row align-items-center mb-5">
                        <div class="col-lg-6 mb-4 mb-lg-0">
                            <img src="{{ asset('assets/img/hero_logistics_1777043517461.webp') }}" alt="Sea Freight Detail"
